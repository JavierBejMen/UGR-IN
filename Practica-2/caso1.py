...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 16 02:17:04 2017
...
#seleccionar accidentes de tipo 'colisiÃ³n de vehÃ­culos'
...
#path = 'Caso_1/clustermaps/'
#doClusterHeatMap(Xclhm, path)
...
for name, algorithm in algorithms:
    ...
    path = "Caso_1/results" + name + '{:}'.format(n_Clust)+'.txt'
    ...
    path = 'Caso_1/scatter_plots/'+name+'{:}'.format(n_Clust)+'SP.png'
...
path = "Caso_1/globresultsTable"+ '{:}'.format(n_Clust)+'.txt'
